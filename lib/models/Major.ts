...
export default class Major {
  ...
  static readonly ALL: Major[] = [
    ...
    new Major("AE", "me", "วิศวกรรมยานยนต์", null , "directions_car", MAJOR_CATEGORY.Thai),
    ...
    new Major("CEDT", "cp", "วิศวกรรมคอมพิวเตอร์และเทคโนโลยีดิจิทัล (CEDT)", "CEDT", "code", MAJOR_CATEGORY.Thai),
