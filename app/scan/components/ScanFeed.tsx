...
const ScanFeed: StyleableFC<{
  ...
  return (
    <div
      className={cn(
        `relative isolate grid h-dvh place-content-center overflow-hidden
        before:absolute before:inset-0 before:top-auto before:h-80
        before:bg-gradient-to-t before:from-black before:content-['']`,
        className,
      )}
      style={style}
    >
      <Icon
        name="no_photography"
        size={48}
        className={cn(`text-brown absolute top-1/2 left-1/2 -z-10
           -translate-1/2`)}
      />
      <video
        ref={ref}
